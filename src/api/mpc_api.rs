// Provider-neutral HTTP capability; SDK signing belongs in Gateway adapters.
use crate::{
...
mod tests {
    ...
    #[actix_web::test]
    async fn nia_balances_are_exposed_with_schema_and_exact_decimal_strings() {
        let asset = serde_json::json!({
            "asset_id":"nia-fixture", "ticker":"DFNSNIA", "name":"NIA fixture", "details":null,
            "precision":0, "issued_supply":0, "timestamp":0, "added_at":0, "media":null, "reject_list_url":null,
        ...
        let assets: rgb_lib::wallet::Assets = serde_json::from_value(serde_json::json!({
            "nia":[asset], "bfa":null, "cfa":null, "uda":null, "ifa":null
        }))
        .unwrap();
